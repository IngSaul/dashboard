...
import { createSession, deleteSessionByToken, sweepExpiredSessions, touchSession, validateSessionToken, } from '../src/auth/session.js';
...
describe('session', () => {
    ...
    it('sweepExpiredSessions removes only expired rows', () => {
        ...
        const remaining = db.prepare('SELECT COUNT(*) AS count FROM sessions').get();
