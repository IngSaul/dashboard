 ...
 * `widgets` is empty — `WorkspaceColumn.css`'s `:empty` rule collapses it
 * without leaving a gap, per the UI contract's Widget Grid rules.
 */
export function WorkspaceColumn({ widgets, className, label }: WorkspaceColumnProps) {
  return (
