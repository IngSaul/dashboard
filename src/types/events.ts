...
export interface EventMap {
  ...
  /** `useShortcutLibrary` persisted a shortcut/category add/edit/remove — `ShortcutsWidget` re-reads `configStore` on this, since neither has an owning state slice to react through instead. */
